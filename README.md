...
<b><h4>(Please note that I'm working on coverting the architecture of this project to MVVM and changing the programming language to Kotlin, will notify when its done)</font></h4></b>
<br/>
